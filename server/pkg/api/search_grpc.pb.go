...
type SearchingClient interface {
	Search(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*AddResponse, error)
}
...
func (c *searchingClient) Search(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*AddResponse, error) {
	out := new(AddResponse)
...
type SearchingServer interface {
	Search(context.Context, *AddRequest) (*AddResponse, error)
}
...
func (UnimplementedSearchingServer) Search(context.Context, *AddRequest) (*AddResponse, error) {
...
func _Searching_Search_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SearchingServer).Search(ctx, req.(*AddRequest))
	}
